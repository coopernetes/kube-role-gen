...
Download the [latest release](https://github.com/coopernetes/kube-role-gen/releases/latest):

```bash
curl -LO https://github.com/coopernetes/kube-role-gen/releases/latest/download/kube-role-gen_Linux_x86_64.tar.gz
